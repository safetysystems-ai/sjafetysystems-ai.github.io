...
<div class="project-meta-flex-row">
  <div class="project-meta-logo-col">
    <img src="/assets/images/Telehealth.png" alt="Telehealth Logo" />
  </div>
  <div class="project-meta-divider"></div>
  <div class="project-meta-info-col">
    <div class="project-meta-title2">
      Enhancing Young Adult Mental Health Care
    </div>
    <div class="project-meta-row2"><b>Summary:</b> The Role of Multi-Sensory Environments in Telehealth-Based Mental Health Interventions</div>
    <div class="project-meta-row2"><b>Sponsor:</b> Texas A&M Telehealth Institute</div>
    <div class="project-meta-row2"><b>Role:</b> Co-PI </div>
    <div class="project-meta-row2"><b>Amount:</b> $25,000 </div>
    <div class="project-meta-row2"><b>Collaborator:</b> PI: Dr. Roxana Jafari </div>
    <div class="project-meta-row2"><b>Period:</b> 2025.07.01 ~ 2026.06.30</div>
