...
<div class="project-meta-flex-row">
  ...
  <div class="project-meta-info-col">
    ...
    <div class="project-meta-row2"><b>Summary:</b> Breaking Risk Habituation to Occupational Hazards</div>
    ...
    <div class="project-meta-row2"><b>Amount:</b> $750,000 </div>
    <div class="project-meta-row2"><b>Collaborator:</b> PI: Dr. Phil Lewis, Co-PI: Dr. Brian A. Anderson </div>
    <div class="project-meta-row2"><b>Period:</b> 2020.09.01 ~ 2025.08.31</div>
     <div class="project-meta-row2">
      <b>More Details:</b>
      <a href="https://www.nsf.gov/awardsearch/showAward?AWD_ID=2017019&HistoricalAwards=false" target="_blank" style="color:#2653ad; font-weight:600; margin-left:3px;">[Link]</a>
    </div>
  </div>
</div>
