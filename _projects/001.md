...
@media (max-width: 850px) {
  ...
  .project-meta-logo-col img { width: 60px; height: 60px; }
...
@media (max-width: 700px) {
  .project-meta-flex-row { flex-direction: column; align-items: stretch; width: 100vw; margin-left: -50vw; border-radius: 0; }
  .project-meta-logo-col, .project-meta-info-col { justify-content: flex-start; }
  .project-meta-divider { display: none; }
  .project-meta-logo-col { padding-left: 10vw; }
  .project-meta-logo-col img { width: 50px; height: 50px;}
}
</style>
...
<div class="project-meta-flex-row">
  ...
  <div class="project-meta-info-col">
    ...
    <div class="project-meta-row2"><b>Summary:</b> Collaborative Research: Worksite-specific Safety Training Environments with Augmented Reality</div>
    <div class="project-meta-row2"><b>Sponsor:</b> National Science Foundation (NSF)</div>
    <div class="project-meta-row2"><b>Role:</b> Former PI, Currently Co-PI </div>
    <div class="project-meta-row2"><b>Amount:</b> $850,000 ($546,164 at UD) </div>
    <div class="project-meta-row2"><b>Collaborator:</b> University of Nevada, Las Vegas, University of Dayton </div>
    <div class="project-meta-row2"><b>Period:</b> 2023.06.15 ~ 2026.05.31</div>
     <div class="project-meta-row2">
      <b>More Details:</b>
      <a href="https://www.nsf.gov/awardsearch/showAward?AWD_ID=2302819&HistoricalAwards=false" target="_blank" style="color:#2653ad; font-weight:600; margin-left:3px;">[Link]</a>
    </div>
  </div>
</div>
